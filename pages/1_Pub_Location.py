...
image=Image.open('images/location.jpg')
st.image(image,use_column_width=True)

location_type=st.selectbox("Select the location type:",('Postal Code','Local Authority'))
...
if not filtered_df.empty:
    ...
    #adding markers for each pub location
    mc=MarkerCluster()
